  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-foreground font-bold tracking-tight text-2xl md:text-5xl">My Habits</h1>
          <p className="text-muted-foreground">Manage and track your habits</p>
        </div>
        <Link
          href="/dashboard/habits/new"
          className="bg-primary text-white px-4 py-2 rounded-xl hover:bg-indigo-700 transition-colors flex items-center gap-2"
        >
          <svg
            className="w-5 h-5"
            fill="none"
      ...
      {/* Stats Summary */}
      {habits.length > 0 && (
        <div className="bg-card rounded-xl p-6 mt-8 border-[#79ffd2]">
          <h2 className="font-semibold text-primary mb-4">Summary</h2>
